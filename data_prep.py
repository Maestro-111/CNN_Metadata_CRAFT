...
def augementation(images_dir,max_bound,output_dir):
    ...
    images_len = len(images) # the number of images in survey training

    # 800
    # 720 <= num*images_len <= 800
    # 720//images_len <= x <= 800//images_len
